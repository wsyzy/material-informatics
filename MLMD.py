...
if select_option == "Home Page":
    ...
    **Developers**: Jiaxuan Ma (PhD Candidate), Bin Cao (PhD Candidate), Yuan Tian (Doctor), Jie Xiong (Assist Prof), Sheng Sun (Prof)
    ...
    if sub_option == "Databases":
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 4.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig7.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 4_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig8.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 5.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig9.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 5_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig10.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 6.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig11.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 6_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig12.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 7.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig13.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 7_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig14.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 8.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig15.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 8_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig16.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 9.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig17.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 9_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig18.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 10.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig19.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 10_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig20.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 11.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig21.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 11_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig22.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 12.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig23.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 12_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig24.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 13.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig25.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 13_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig26.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 14.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig27.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 14_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig28.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 15.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig29.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 15_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig30.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 16.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig31.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 16_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig32.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 17.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig33.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 17_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig34.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 18.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig35.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 18_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig36.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 19.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig37.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 19_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig38.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 20.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig39.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 20_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig40.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 21.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig41.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 21_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig42.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 22.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig43.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 22_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig44.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 23.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig45.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 23_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig46.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 24.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig47.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 24_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig48.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 25.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig49.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 25_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig50.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 26.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig51.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 26_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig52.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 27.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig53.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        with col2:
            df = pd.read_csv('./data/Case 27_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig54.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
        ...
        col1, col2 = st.columns([2, 2])
        with col1:
            df = pd.read_csv('./data/Case 28.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig55.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)

        with col2:
            df = pd.read_csv('./data/Case 28_R.csv')
            st.write("Porous metamaterials structure")
            image = Image.open('./data/fig56.png')
            st.image(image, width=280, caption='')
            tmp_download_link = download_button(df, f'data.csv', button_text='download')
            st.markdown(tmp_download_link, unsafe_allow_html=True)
